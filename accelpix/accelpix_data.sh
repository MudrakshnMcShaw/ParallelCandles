/usr/local/bin/pm2 stop accelpix_data_service || true
/usr/local/bin/pm2 delete accelpix_data_service || true
...
/usr/local/bin/pm2 start "/root/ParallelCandles/accelpix/venv/bin/python3 /root/ParallelCandles/accelpix/data2.py" --name accelpix_data_service